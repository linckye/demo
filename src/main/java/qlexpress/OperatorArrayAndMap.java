 ...
 * @author linckye
 */
public class OperatorArrayAndMap extends OperatorBase  {
    public OperatorArrayAndMap(String aName) {
        this.name = aName;
    }
    public OperatorArrayAndMap(String aAliasName, String aName, String aErrorInfo) {
        this.name = aName;
